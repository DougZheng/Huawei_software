...
int main() {
    ...
    auto ans1 = judge("../1_data/training-1.txt", "../1_data/training-1.out");
    auto ans2 = judge("../1_data/training-2.txt", "../1_data/training-2.out");
    std::cerr << "\ndataset1:" << std::endl;
